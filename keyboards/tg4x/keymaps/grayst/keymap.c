...
combo_t key_combos[COMBO_COUNT] = {
  ...
  [LP_EXLM] = COMBO(lp_combo, KC_EXLM)
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT( /* QWERTY */
          KC_GESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_SCLN, KC_BSPC,
          KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_QUOT, KC_ENT,
          LSFT_T(KC_CAPS), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_F13),
          KC_LCTL, KC_LALT, KC_LGUI,  LT(1, KC_SPC), KC_SPACE, KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),

    [1] = LAYOUT( /* NUM-SYM-NAV */
        KC_SLEP, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL,
        KC_TAB, KC_LBRC, KC_RBRC, KC_NO, KC_R, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_BSLS,
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_COMM, KC_DOT, KC_SLSH, KC_ENT,
        KC_LCTL, KC_LALT, KC_LGUI, KC_TRNS, LT(2, KC_SPC),  KC_RGUI, KC_NO, KC_NO, KC_NO
    ),
